...
public class WardrobeService {
    ...
    public WardrobeItemResponse createItem(Long authenticatedUserId, CreateWardrobeItemRequest request) {
        ...
        if (request.hasImageUrl()) {
            ...
            sourceBytes = pinnedHttpDownloader.download(originalUrl, properties.maxImageBytes());
        ...
        ImageSafetyGate.rejectUnsafeHeader(sourceBytes);
        ...
        ImageSafetyGate.rejectUnusablePixels(finalBytes);
